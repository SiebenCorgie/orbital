use egui::{Widget, Vec2, Sense, Stroke};
    ...
    fn ui(self, ui: &mut egui::Ui) -> egui::Response {
        ...
        match self.state{
            true => {
                ...
                painter.line_segment(
                    [
                        ...
                        rect.center() + Vec2{x: -Self::ICOSIZE / 2.0, y: Self::ICOSIZE / 2.0}
                    ],
                    Self::STROKE
                );
                painter.line_segment(
                    [
                        rect.center() + Vec2{x: -Self::ICOSIZE / 2.0, y: Self::ICOSIZE / 2.0},
                        rect.center() + Vec2{x: Self::ICOSIZE / 2.0, y: 0.0}
            ...
            false => {
                ...
                painter.line_segment(
                    [
                        rect.center() - Vec2{x: -Self::PAUSE_WIDTH, y: -Self::ICOSIZE / 2.0},
                        rect.center() - Vec2{x: -Self::PAUSE_WIDTH, y: Self::ICOSIZE / 2.0},
                    ],
                    Self::STROKE
                );
